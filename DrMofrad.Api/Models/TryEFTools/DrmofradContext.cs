...
using DrMofrad.Api.Models.TryEFTools;

#nullable disable

namespace DrMofrad.Api.Models\TryEFTools
{
    public partial class DrmofradContext : DbContext
    {
        public DrmofradContext()
        {
        }

        public DrmofradContext(DbContextOptions<DrmofradContext> options)
            : base(options)
        {
        }
